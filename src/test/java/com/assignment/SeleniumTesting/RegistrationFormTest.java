...
public class RegistrationFormTest {
	...
	public void validFormtest() {
		form.populate();
		form.submit();
		assertEquals("Succesful registration. Please Login.",
				form.findById("message").get(0).getText());
	}

	@Test
	public void TestFormDoesNotAcceptNumbers() {
		form.populateName("6");
		assertEquals("Invalid characters", form.findById("name_error").get(0)
				.getText());
	...
	public void TestDoesNotAcceptNumberForSnamemeTest() {
		...
		assertEquals("Invalid characters", form.findById("surname_error")
				.get(0).getText());
	...
	public void InvalidPasswordTest() {
		...
		assertEquals("Password is too short", form.findById("password_error")
				.get(0).getText());
	}
	...
	public void TestFormemptyage() {
		...
		assertEquals("Please enter date of birth", form.findById("dob_error")
				.get(0).getText());
	...
	public void InvalidcardTest() {
		...
		assertEquals("Invalid card", form.findById("creditcard_error").get(0)
				.getText());
	}
	...
	public void InvalidexpiryTest() {
		...
		assertEquals("Invalid Expirary date", form.findById("expiry_error")
				.get(0).getText());
	}
	...
	public void InvalidxtcvvTest() {
		...
		assertEquals("Invalid CVV number", form.findById("cvv_error").get(0)
				.getText());
